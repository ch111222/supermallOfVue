<template>
  <div id="home">
      ...
      <tab-control  :titles="['流行','新款','甄选']" @tabClick="tabClick" ref="tabControl1" class="tab-control" v-show="isTabFixed"/>
   <scroll class="content"
               ...
               <feature-view/>
               <tab-control  :titles="['流行','新款','甄选']" @tabClick="tabClick" ref="tabControl2"/>
